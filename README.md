...
The lifetime of a service is tied to the lifetime of the entire container for singleton services
and should be managed by the client code if the factory is configured in a transient mode.
